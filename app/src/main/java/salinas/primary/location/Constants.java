...
public class Constants {
    ...
    public static final String BROADCAST_CONNECTION_STATUS = "salinas.primary.location.BROADCAST_CONNECTION_STATUS";
    public static final String IS_FAILED_CONNECTION = "IS_FAILED_CONNECTION";
